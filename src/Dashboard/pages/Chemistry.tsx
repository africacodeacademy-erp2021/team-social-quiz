    ...
    <>
      <div className="screen">
        ...
        <div className="game-1" >
          ...
          <span id="Play-btn"><Playandshare path="/MolesAndBonds"/><Share/></span>
        ...
        <div className="game-2" >
          ...
          <span id="Play-btn"><Playandshare path="/Polymers" /><Share/></span>
        ...
        <div className="game-3" >
          ...
          <span id="Play-btn"><Playandshare path="/LabTechniques"/><Share/></span>
