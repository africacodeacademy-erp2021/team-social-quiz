...
import PopC from "../Images/HistoryC3.jpg";
...
function Planets() {
  ...
  useEffect(()=>{ 
    fetch("http://localhost:4000/api/v1/category?categoryId=619172560d822d00b4e956c5")
      ...
      .then((json) => {
        console.log(json[2].description);
        setData(json[2].description);
      })
    },[]) 
    ...
    <div className="medals-Icons">
     ...
     <img id="Medal" src={Medal} alt="Medal" />
        ...
        <span id="Tupac"><p>What is the biggest planet in our solar system?</p></span>
        <div>
        <img  className="RecordImage" src={Record} alt="Hand"/>
        </div>
        <span id="Records"><p>How much mass does the sun occupy in our solar system?</p></span>
        <div>
        <img  className="FlagImage" src={Flag} alt="Flag"/>
        </div>
        <span id="FlagText"><p>What is the biggest planet in our solar system?</p></span>
